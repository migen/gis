...
$dbo=PDBO;
	...
	include_once(SITE.'functions/storesFxn.php');
	...
	if(isset($_POST['submit'])){
		...
		flashRedirect("stores","Sale Added # $pos_id.");
		exit;
	}
	
	
	$this->view->render($data,"stores/indexStores");
...
public function view($params=NULL){
	...
	$this->view->render($data,"stores/viewSale");
...
$this->view->render($data,"stores/reportStores");	
...
public function test(){
	...
	$this->view->render($data,"stores/testStores");
}	/* fxn */
