...
function tallyAve(){
	...
	$('#tpgave').val(tpgave.toFixed(rcardgdeci));
...
<h5>
	Edit DG Student Cav <span onclick="tracehd();" class="u" >Traits</span> |
	...
	<?php else: ?>
		...
		| <a href='<?php echo URL."cav/student/$course_id/$scid/$sy/$qtr"; ?>' >Num Student</a>	
	<?php endif; ?>
...
<tr>
	...
	<?php $dgdb=$grades[$i]['dg']; 	?>
	<td><?php echo $dgdb; ?></td>		
	<td><input class="dg vc50 center" name="grades[<?php echo $i; ?>][dg]" 
		value="<?php echo $dgdb; ?>" tabindex="2"  /></td>			
	<input type="hidden" name="grades[<?php echo $i; ?>][gid]" value="<?php echo $grades[$i]['gid']; ?>"   />
</tr>
<?php endfor; ?>
<th colspan="3" >Final (Average)</th>
<?php 
	$dgfdb=$grades[0]['dgfinal']; 
?>
<td><input class="vc50 center" name="post[dgfinal]" 
	value="<?php echo $dgfdb; ?>" tabindex="2"  /></td>
