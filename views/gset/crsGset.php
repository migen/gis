...
<h5>
	...
	| <a href="<?php echo URL.'gset/crs?all'; ?>" />All</a>  
...
<?php foreach($levels AS $sel): ?>
	<a href='<?php echo URL."gset/crs/".$sel['id']; ?>' ><?php echo $sel['code']; ?></a> &nbsp;  &nbsp;  
<?php endforeach; ?>
</p>


<div style="z-index:2;background-color:#ccc;position:fixed;top:30%;left:70%;width:200px;" class="hd" id="names" > </div>
<div class="clear" ></div>
