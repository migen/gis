...
<?php if($srid==RMIS): ?>	
	...
	| <a href='<?php echo URL."gset/crs/4"; ?>'>Manage</a>
<?php endif; ?>	
</span>
</h5>
...
<p>
	<?php foreach($levels AS $row): ?>
		<a href='<?php echo URL."data/courses/".$row['id']; ?>' ><?php echo $row['code']; ?></a> &nbsp;&nbsp;   
	<?php endforeach; ?>
</p>
