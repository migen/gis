...
<?php if($get['paymode']>0): ?>
<td class="right" ><?php $currdue=$dues[$i]; echo number_format($currdue,2); ?></td>
<td class="right" ><?php $currdue=$dues[$i]; echo number_format($currpaid,2); ?></td>
<td class="right" ><?php $currbal=round($currdue,2)-round($currpaid,2); echo number_format($currbal,2); ?></td>
<?php 
