...
<?php 
	...
	$incs = SITE."views/elements/accor_gset.php";include_once($incs); 
...
<div class="oneGroup" >
<?php 
	$incs=SITE."views/elements/accor_axis.php";include_once($incs); 		
	$incs=SITE."views/elements/accor_invis.php";include_once($incs); 		
	$incs=SITE."views/elements/accor_axis_gset.php";include_once($incs); 		
	$incs=SITE."views/elements/accor_batch.php";include_once($incs); 		
...
<div class="oneGroup" >
<?php 
	$incs=SITE."views/elements/accor_features.php";include_once($incs); 
	$incs=SITE."views/elements/accor_devtools.php";include_once($incs); 
	$incs=SITE."views/elements/accor_stats.php";include_once($incs); 
...
<div class="oneGroup" >
<?php 
	$incs = SITE."views/elements/accor_lab.php";include_once($incs); 
	$incs = SITE."views/elements/accor_syncmis.php";include_once($incs); 
