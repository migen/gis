...
<h5 class="screen" >
	Honors Report - <?php echo $level['name']; ?> (<?php echo $count; ?>)
	| <?php $this->shovel('homelinks'); ?>
	| <a href="<?php echo URL.'lir'; ?>" >L I R</a>	
	| <span class="u" onclick="pclass('hd');" >ID Number</span>
	| <a href="<?php echo URL.'honors/process/'.$lvl; ?>" >Process</a>
...
<div class="reports-honors">
	<div class="header">
		...
		<div class="school">
			<p>
				...
				<span class="yrsec"><span class="" ><?php echo $level['name']; ?></span>	</span><br>
	...
	<table>
		<thead>
			<tr>
				<th class="center" width="300">Section</th>
