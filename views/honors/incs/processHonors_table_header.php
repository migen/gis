...
<?php 	
	...
	$header.='<th class="center '.($row["is_primary"]==1)? "bg-lightgreen":NULL.'" >';	
		$header.=$row["code"].'<br />'.($row["supsubject_id"]<1)? NULL:"#".$row["supsubject_id"];
			
		if($row['is_primary']==1){ $ctpri++; $header.='<br />'.$ctpri; }
...
<table class="gis-table-bordered table-altrow" style="font-size:0.8em;" >
	...
	<tr><td>1: Genave/ Summarizer above 87 (3rd) | above 95 (2nd) | above 98 (1st)</td></tr>
