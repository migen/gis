...
function getHonorsStudents($db,$dbg,$crid,$qtr,$fields="c.id",$cond,$order="genave DESC"){	
	...
	$q="SELECT $fields,summ.scid,c.code AS studcode,c.name AS student,sx.`honor_q{$qtr}` AS `dbhonor`
...
<td><?php $honor_dg=getHonorByGenave($genave); echo ($is_qual)? $honor_dg:'-'; ?></td>
