...
<h5 class="screen" > Information  (*Required)
	...
	<?php if(isset($is_student) && ($is_student)): ?>
		...
		| <a href="<?php echo URL.'students/links/'.$ucid; ?>">Links</a> 
	<?php endif; ?>
	<?php if($_SESSION['srid']==RMIS): ?>
		| <a onclick="return confirm('Dangerous! Sure?');" href="<?php echo URL.'mis/purge/'.$ucid; ?>" >Purge</a>
	<?php endif; ?>		

<?php if($_SESSION['srid']==RMIS): ?>	
	| <a href='<?php echo URL."mgt/users/$ucid"; ?>' >Users</a> 
<?php endif; ?>
...
<img src="data:image/jpeg;base64,<?php echo base64_encode($row['photo']); ?>" width="150" border="0" /></td></tr>
<tr><th>Login Account</th><td><?php echo $row['account']; ?></td></tr>
<tr><th class="vc200" >ID No | Code</th><td class="vc500"  ><?php echo $row['code']; ?>
<?php if($srid==RMIS): ?> 
- <a href='<?php echo URL."codename/one/$ucid"; ?>' >Edit ID</a>
| <a href='<?php echo URL."mgt/pass/$ucid"; ?>' >Edit Pass</a>
<?php endif; ?>
</td></tr>
...
<?php if($is_employee): ?>	<!-- if employee -->

<?php if($is_student): ?>	<!-- if student -->
	...
	<tr><th>C-Crid</th><td><input class="full pdl05" name="contact[crid]" value="<?php echo $contact['ccrid']; ?>" 
		<?php echo ($is_admin)? NULL:'readonly'; ?>   ></td></tr>
		
	<tr><th>SumCrid</th><td><input class="full pdl05" name="summ[crid]" value="<?php echo $contact['sumcrid']; ?>" 
		<?php echo ($is_admin)? NULL:'readonly'; ?>   ></td></tr>

<?php if($has_axis): ?>
	<tr><th>TsumCrid</th><td><input class="full pdl05" name="tsum[crid]" value="<?php echo $contact['tsumcrid']; ?>" 
		<?php echo ($is_admin)? NULL:'readonly'; ?>   ></td></tr>
<?php endif; ?>		
...
<?php endif; ?>
	...
	<tr class="shd" >
		<th>Ucid</th>
		<td>
			Summ <?php echo $row['sumucid']; ?>
			| CTP <?php echo $row['ctpucid']; ?>
			| Profile	<?php echo $row['profpcid']; ?>		
			| Photo	<?php echo $row['photopcid']; ?>					
		</td>
	</tr>
