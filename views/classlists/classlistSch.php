...
<tr>
	...
	<td><a href="<?php echo URL.'students/links/'.$boys[$i]['scid']."?sch=".$_GET['sch']; ?>" ><?php echo $boys[$i]['student_code']; ?></a></td>
	<td><?php echo $boys[$i]['student']; ?></td>
	<td><a href='<?php echo URL."profiles/student/".$boys[$i]['scid']."?sch=".$_GET['sch']; ?>' >Profile</a></td>		
	<?php if($_SESSION['settings']['rcard_adviser']==1): ?>
		<td><a href='<?php echo URL."rcards/scid/".$boys[$i]['scid']."/$sy/$qtr/0?tpl=".$dept."&sch=".$_GET['sch']; ?>' >
			Report Card</a></td>		
	<?php endif; ?>
