...
<tr><th class="white bg-blue2" >Account-Pass</th><td><?php echo $classroom['account'].'-'.$classroom['ctp']; ?></td></tr>	
<?php endif; ?>	
</table>
</div>
...
<tr>
	<td><?php echo $i+1; ?></td>
	<td class="scid" ><?php echo $boys[$i]['scid']; ?></td>
...
<tr>
	<td><?php echo $i+1; ?></td>
	<td class="scid" ><?php echo $girls[$i]['scid']; ?></td>
