...
<h5>
	Std Add Activity Scores 2-Tier |
...
<table class='gis-table-bordered table-fx table-altrow' style="font-size:<?php echo $size; ?>em;">
...
<br /><p>
	...
	<button onclick="resetForm('form');return false;" >Cancel</button>
</p>
