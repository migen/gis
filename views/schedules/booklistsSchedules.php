...
<h3>
	Scheduling (Booklist Viewing) (<?php echo $count; ?>) | <?php $this->shovel('homelinks'); ?>
...
<div class="clear" >
	<a href="<?php echo URL.'schedules/booklists'; ?>" >All</a> |
<?php foreach($levels AS $sel): ?>
	<a href="<?php echo URL.'schedules/booklists?lvl='.$sel['id']; ?>" ><?php echo $sel['code']; ?></a> | 
<?php endforeach; ?>
</div>
<br>
<table class="gis-table-bordered" >
	<tr><th colspan=3>Status</th></tr>
	<tr><th>Open</th><td>1</td><td>Students can view booklist.</td></tr>
	<tr><th>Close</th><td>0</td><td>Students <span class="b" >CANNOT</span> view booklist.</td></tr>
</table><br />
...
<tr>
	...
	<th>Classroom - ID</th>
	<th>Booklist<br />
		<input autofocus type="number" min=0 max=1 class="pdl05 vc50 center" id="ibooklist" value=0 /><br />	
		<input type="button" value="All" onclick="populateColumn('booklist');" >									
	</th>
	<th></th>
</tr>
...
<tr>
	...
	<td>
		<input type="number" min=0 max=1 class="vc50 booklist center" value="<?php echo $row['booklist']; ?>"
			id="booklist-<?php echo $i; ?>" name="posts[<?php echo $i; ?>][booklist]"  />
...
function xeditRow(i){
	...
	const booklist = $('#booklist-'+i).val();
	
	var vurl 	= gurl + '/ajax/axdata.php';	
	var task	= "xeditData";	
	var pdata = "task="+task+"&dbtable="+dbtable+"&id="+pkid+"&booklist="+booklist;
