...
<td>
	<a href='<?php echo URL."matrix/grades/".$rows[$i]['id']."/$prevsy/$qtr"; ?>' ><?php echo $prevsy; ?></a>
...
<?php if($rows[$i]['level_id']<14): ?>
	<a href='<?php echo URL."rcards/crid/".$rows[$i]['id']."/$prevsy/$qtr?tpl=".$rows[$i]['department_id']; ?>' ><?php echo $prevsy; ?></a>
