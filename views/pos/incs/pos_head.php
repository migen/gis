...
<p><table class="gis-table-bordered table-fx" >
	...
	<tr>
		<th>OR No | CCID</th>
		<td>
			<input class='pdl05 vc100' name='pos[orno]' value="<?php echo $orno; ?>" />
	...
	<tr>
		<th>Ecid | Trml</th>
		<td>
			<input class="center vc50" value="<?php echo $_SESSION['ucid']; ?>" />
			<input class='pdl05 vc50' name='pos[terminal]' value="<?php echo $terminal; ?>" type="number" /></td>
	</tr>	
	<tr>
		<th>Time</th>
