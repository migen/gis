...
#posDiv{ font-size:0.6em; font-family: Arial,Helvetica Neue,Helvetica,sans-serif; }
.col-qty,.col-item,.col-amt,.posLetterhead{ font-family: Arial,Helvetica Neue,Helvetica,sans-serif; } 
#posheadrow > th { font-size:0.8em; }
#rxnote,tr > td { font-size:0.6em; font-family:Arial,Helvetica,sans-serif; }
.col-qty{ width:10%; }
.col-amt{ text-align:right; }
.right{ text-align:right; }
.left{ text-align:left; }

#postable > tr > td, #postable > tr > th{ font-size:1.2em; color:red; }
