...
<h3>
    Custom Average (Classroom)
    | &deci=<?php echo $decigenave; ?>
    | &sy=<?php echo $sy; ?>
    | <?php $this->shovel('homelinks'); ?>

    <?php if($lvl>13): ?>
        | <a href="<?php echo URL.'genave/custom/'.$crid.'/1/2/5'; ?>" >Sem1</a>
        | <a href="<?php echo URL.'genave/custom/'.$crid.'/3/4/6'; ?>" >Sem2</a>
        | <a href="<?php echo URL.'genave/custom/'.$crid.'/5/6/7'; ?>" >Final</a>
    <?php endif; ?>    
...
<tr>
    ...
    <th>ID No.</th>
    <th>Student</th>
    <th><?php echo ucfirst($qa); ?></th>
    <th><?php echo ucfirst($qb); ?></th>
