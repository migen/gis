...
<tr>
	...
	<?php $total+=$amt; ?>
	<td class="shd" >
		<button><a href="<?php echo URL.'delivery/edit/'.$drrows[$i]['pxid']; ?>" >Edit</a></button>
		<button id="btn-<?=$i?>" onclick="xdeletePx(<?php echo $i; ?>);" >Delete</button>	
	</td>
