...
<h5>
	<span ondblclick="xxtracehd();" >Loads</span> | 
...
<?php if($admin): ?>
	...
	<tr><th class="headrow white" >Teacher</th><td><?php echo $teacher['teacher']; ?></td></tr>
	<?php if(!empty($teacher['advisory'])): ?>
		<tr><th class="headrow white" >Advisory</th><td><?php echo $teacher['advisory']; ?></td></tr>	
	<?php endif; ?>
	</table> <br />
<?php endif; ?>
<!------------------------------------------------------------------------------------------------------------------------>
...
<?php for($i=0;$i<$num_courses;$i++): ?>
	...
	<tr id="tr<?php echo $i; ?>" class="<?php echo (!$active)? 'red':NULL; ?>"  >
		...
		<td><input class="pdl05 vc60" name="courses[<?php echo $i; ?>][tcid]" 
