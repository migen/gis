...
<h5 class="" >
	<span class="u" ondblclick="tracepass();" >Payables</span> Report 
	<?php echo (isset($count))? '('.$count.')':NULL; ?>| <?php $this->shovel('homelinks'); ?>
	<span class="hd" >HD</span>
<span class="screen" >
	| <a href="<?php echo URL.'payables/report'; ?>" >Filter</a>
...
if(isset($_GET['filter'])){
	$incs = 'incs/payables_table.php';
	include_once($incs);
} else {
	include_once('incs/payables_filter.php');
}
