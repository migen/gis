...
<h3>
	GIS Ledger Filter <?php echo $sy; ?> | <?php $this->shovel('homelinks'); ?>
	...
	| <a href="<?php echo URL.'sessions/setter/filter_dropdown/1'; ?>" >Dropdown</a>
...
<tr class="shd addPayment" >
	...
	<td class="vc200" >
		...
		<input type="submit" name="auto" value="Filter" onclick="filterFeetypes(dbfeetypes,1);return false;" />		
		<input id="feetype_id-1" class="vc50" />		
		
	</td>
	<td><input class="right" id="amount-1" class="vc100" value="<?php echo 0; ?>" ></td>
...
<tr class="shd addPayment" >
	...
	<td class="vc200" >
		...
		<input type="submit" name="auto" value="Filter" onclick="filterFeetypes(dbfeetypes,2);return false;" />		
