...
<h4>
	...
	| <a href="<?php echo URL.'sessions/setter/filter_dropdown/0'; ?>" >Filter</a>
...
<table class="gis-table-bordered" >
	...
	<tr><th>Student</th><td><?php echo $student['studname']; ?></td>
		<th>Cash</th><th class="right" ><?php echo number_format($tfee_total,2); ?></th>
...
<tr class="shd addPayment" >
	...
	<td><input id="orno-2" class="vc100"  ></td>	
...
function putPayment(dbtable,num){
	...
	pdata+="&date="+date+"&ecid="+ecid+"&reference="+reference+"&orno="+orno;
	$('#btnAdd-'+num).hide();
