...
<tr>
	...
	<td><a href="<?php echo URL.'ranks/level/'.$rows[$i]['id'].DS.$sy.DS.$qtr; ?>" >Ranks</a></td>
	<td><a href="<?php echo URL.'registrars/qlra/'.$rows[$i]['id'].DS.$sy.DS.$qtr; ?>" >R-Genave</a></td>
	<td><a href="<?php echo URL.'honors/level/'.$rows[$i]['id'].DS.$sy.DS.$qtr; ?>" >Honors</a></td>
	...
	<td><a href="<?php echo URL.'registrars/lbis/'.$rows[$i]['id'].DS.$sy.DS.$qtr; ?>" >Subject</a></td>
