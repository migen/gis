...
<tr>
	...
	<td>
		<select name="posts[<?php echo $i; ?>][prodtag_id]" >
			<?php foreach($prodtags AS $sel): ?>
				<option value="<?php echo $sel['id']; ?>" <?php echo ($sel['id']==$rows[$i]['prodtag_id'])? 'selected':NULL; ?> >
...
<p>	
	...
	<button><a href="<?php echo URL.'products/types'; ?>" class="no-underline" >Cancel</a></button>
</p>
