...
<div class="third" >	<!-- summary -->
	...
	<tr><th>Total Surg Paid</th><td class="vc120 right" ><?php echo number_format($tsurgpaid,2); ?></td></tr>
...
function redirContact(ucid){
	var url 		= gurl + '/ledgers/edit/' + ucid;	
	window.location = url;		
}
...
function redirSy(){
	var sy=$('#sy').val();
	var url=gurl+'/ledgers/edit/'+scid+'/'+sy;
	window.location=url;	
}	/* fxn */
