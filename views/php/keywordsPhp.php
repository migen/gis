<h5>
	PHP Keywords | <?php $this->shovel('homelinks'); ?>
    ...
    <caption><strong>PHP Keywords</strong></caption>
     ...
     <tbody class="tbody">
      ...
      <tr>
       ...
       <td>
        <a href="language.types.callable.php" class="link">callable</a> (as of PHP 5.4)
       </td>
       <td>
      ...
      <tr>
       ...
       <td>
        <a href="language.exceptions.php" class="link">finally</a> (as of PHP 5.5)
       </td>
       <td>
      ...
      <tr>
       ...
       <td>
        <a href="control-structures.goto.php" class="link">goto</a> (as of PHP 5.3)
       </td>
       <td>
      ...
      <tr>
       ...
       <td>
        <a href="language.oop5.traits.php#language.oop5.traits.conflict" class="link">insteadof</a> (as of PHP 5.4)
       </td>
       <td>
      ...
      <tr>
       ...
       <td>
        <a href="language.namespaces.php" class="link">namespace</a> (as of PHP 5.3)
       </td>
       <td>
      ...
      <tr>
       ...
       <td>
        <a href="language.oop5.traits.php" class="link">trait</a> (as of PHP 5.4)
       </td>
      </tr>
      ...
      <tr>
       ...
       <td>
        <a href="language.namespaces.php" class="link">use</a>
       </td>
       <td>
      ...
      <tr>
       ...
       <td>
        <a href="language.generators.php" class="link">yield</a> (as of PHP 5.5)
       </td>
       <td>
        <a href="language.generators.syntax.php#control-structures.yield.from" class="link">yield from</a> (as of PHP 7.0)
       </td>
       <td>
       </td>
       <td>
