...
function addPosItem(){
	...
	$.post(vurl,{task:task,barcode:barcode},function(s){		
		...
		prow='<tr id="trow-'+nr+'"><td><input class="vc50" readonly name="positems['+nr+'][product_id]" value="'+prid+'"  /></td>";
		prow+="<td><input class="vc200" readonly value="'+product+'"  /></td>";
		prow+="<td><input class="vc50" readonly name="positems['+nr+'][cost]" value="'+cost+'"  /></td>";
		prow+="<td><input class="vc50" readonly name="positems['+nr+'][price]" value="'+price+'"  /></td>";
		prow+="<td><input id="'+nr+'" class="vc50" onchange="amt(this.id);return false;" name="positems['+nr+'][qty]" value="'+qty+'" type="number" /></td>";
		prow+="<td><input class="vc50 subtotal" readonly name="positems['+nr+'][amount]" value="'+amount+'"  /></td>";
		prow+="<td><input class="vc50" readonly name="positems['+nr+'][combo]" value="'+combo+'"  /></td>";
		prow+="<td onclick="deltrow('+nr+');"  class="u" >Del</td>";
		prow+="<input type="hidden" name="positems['+nr+'][pocost]" value="'+pocost+'"  />";
		prow+="<input type="hidden" name="positems['+nr+'][level]" value="'+level+'"  /></tr>';
...
<h5>
	...
	| <a href='<?php echo URL."cpos/add"; ?>' >Credits</a>	
