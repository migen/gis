...
<h5>
	Session Ajax | <?php $this->shovel('homelinks'); ?>
...
for (var i = 0; i < cs; i++) {			
	content += '<p> <span id="'+s[i].id+'" class="txt-blue b u" onclick="axnSelected('+s[i].name+');return false;" >'+s[i].name+'</span></p>';
}
