...
<h5>
	...
	| <a href='<?php echo URL."promotions/report/$crid/$sy/$qtr"; ?>' >Report</a>
	&nbsp;&nbsp; 
...
<tr><th><span class="brown" >*Prom Lvl ID</span></th><td>
3 - P03 | 4 - G01 | 5 - G02 | 6 - G03 | 7 - G04 | 8 - G05 | 
9 - G06 | 10 - G07 | 11 - G08 | 12 - G09 | 13 - G10 | 14 - G11 | 15 - G12 </td></tr>
</table>
</h4>
...
<?php if((($_SESSION['srid']==RMIS) || ($_SESSION['srid']==RREG) || ($_SESSION['srid']==RACAD)) && ($is_locked)): ?>
