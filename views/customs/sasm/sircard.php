...
.gis-table-bordered-print { border: 1px solid #000; border-left: 0; border-top: 0; }
.gis-table-bordered-print th, .gis-table-bordered-print td  { border-left: 1px solid #000;  
border-top: 1px solid #000; padding:1px 3px; color:;}
.gis-table-bordered-print th {color:#000; }
