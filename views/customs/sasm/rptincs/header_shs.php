	...
	<table class="nogis-table-bordered-print center " >
		<tr>
			...
			<td>
				<span class="b" style="font-family:Old English Text MT;font-size:2.4em;" >St. Anthony School</span><br />
				...
				<div style="padding-top:0.6em;" ><span style="font-weight:bold;font-size:22px;"  >
					Senior High School</span></div>									
				<span style="font-size:22px;font-weight:bold;" >PROGRESS REPORT CARD &nbsp; (SF9)</span>				
