...
<?php else:	/* 2nd outcome : different criteria  */ ?>		
		...
		<!-- total,trns,pnv -->
		<?php if($subtotal>0): ?>		
			<td class="colshading center tdscore" > <?php echo "<br />"; echo number_format($subtotal,$deciscores); ?></td>
...
<input type='hidden' name="data[Grade][<?php echo $s; ?>][scid]" value="<?php echo $students[$s]['scid']; ?>" >			
			...
			<td class="center  <?php echo ($ge<$pg)? 'bg-red':NULL; ?> " >
					...
					<input class="vc50 center" type="<?php echo $show_dg; ?>" name="data[Grade][<?php echo $s; ?>][dg]" 
...
<?php if($qtr==4): ?> <!-- if Q4 -->			
		<?php 
			...
			$ave=$sumave/$qtr;
			$qfdg=($with_dg)? rating($ave,$ratings):NULL; 

		?>				
		<td>
			<input class="vc50 center" type="text" name="data[Grade][<?php echo $s; ?>][ave]" 
				value="<?php echo number_format($ave,$decigrades);  ?>" readonly />	
			<input class="vc50 center" type="<?php echo $show_dg; ?>" name="data[Grade][<?php echo $s; ?>][dgave]" 
				value="<?php echo $qfdg;  ?>" readonly /> 													
		</td>
<?php endif; ?> <!-- if Q4 -->			
