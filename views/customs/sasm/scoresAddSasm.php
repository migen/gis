...
<p>
	<input onclick="return checkCriteria();" type='submit' name='submit' value='Submit'> &nbsp; 
...
function checkCriteria(){
	...
	if(cri==0){
		alert('Criteria must NOT be empty!'); return false;
	} 
	return true;
...
function jsSubmit(pct){
	...
	var x="num_pass: "+num_pass+" | num_fail: "+num_fail+" | pct: "+pct+" | cutoff_count: "+cutoff_count;
	// alert(x);
