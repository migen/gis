<tr class='bg-blue2' >
	...
	?>
		...
		<?php else: ?>					
			...
			<td class=" " >Total <br /><?php echo '('.$subtotal.')'; $subtotal = 0; ?></td>			
	...
	<?php endfor; ?>	
			...
			<td class="center" valign="top" >Final<br />Ave<br />(DB)</td>
		<?php if(!isset($_GET['printout'])): ?>			
			<td class="center"><?php echo $scores_tnv; ?><br />Q<?php echo $qtr; ?></td>			
			<td class="center"><?php echo $scores_equiv; ?><br />
				<?php if($with_dg): ?>DG<br /><?php endif; ?>
					Credits</td>			
