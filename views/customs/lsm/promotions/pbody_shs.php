...
<tr>
	...
	<td><?php $fgenave  = ($students[$t]['ave_q5']+$students[$t]['ave_q6'])/2; 
		$fgenave=($fgenave<90)? round($fgenave):number_format($fgenave,2);
		echo $fgenave ?></td>	
...
<tr class="center" ><td><?php echo $_SESSION['settings']['school_principal_hs']; ?></td></tr>
<tr class="center" ><td><hr /></td></tr>
