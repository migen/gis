...
<h5>
	<span ondblclick="tracepass();" >ERP Home</span>
	...
	| <a href="<?php echo URL.'teachers/reminders'; ?>" />Reminders</a>		
...
<tr>
	...
	<td>
		<a href="<?php echo URL.'attendance/quarterly/'.$advisories[$i]['crid'].DS.$sy.DS.'5'; ?>">SY</a> |	
		<?php for($a=1;$a<=$qtr;$a++): ?>
