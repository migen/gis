...
<div class="rcardhalf" >
<br />
<table class="gis-table-bordered-print tf12 <?php echo $tblwidth; ?>" >
	<tr><th class='vc150'>ID Number</th><td class="vc300" ><?php echo $student['student_code']; ?></td></tr>
	<tr><th  class=''>Name</th><td><?php echo $student['student']; ?></td></tr>
	<tr><th  class=''>Chinese Name</th><td><?php echo $student['chinese_name']; ?></td></tr>
	<tr><th  class=''>LRN</th><td><?php echo $student['lrn']; ?></td></tr>
	<tr><th class=''>Grade and Section</th><td><?php echo $classroom['name']; ?></td></tr>
	<tr><th class=''>Gender</th><td><?php echo ($student['is_male']==1)?'Male':'Female'; ?></td></tr>
	<tr><th class=''>Curriculum</th><td><?php echo ($classroom['is_k12'])?'K-12':'Non-K12'; ?></td></tr>
	<?php if($classroom['level_id']>$level_shs): ?>
		<tr><th class=''>Track / Strand </th>
		<?php $strand = ($classroom['section_id']==1)? 'ABM/HUMMS':'STEM'; ?>
		<td><?php echo "Academic / $strand "; ?></td></tr>
	<?php endif; ?>	
</table>

<table class="no-gis-table-bordered table-center table-vcenter <?php echo $headfont.' '.$tblwidth; ?>" >	
	<tr><td class="b" >REPORT ON LEARNING PROGRESS AND ACHIEVEMENT</td></tr>
</table>
...
<tr class="<?php echo $headrowfont; ?>" >
	...
	<?php if($qtr>$qtr_fg): ?>
		...
		<th rowspan="2" class="f9" >Remarks</th>
	<?php endif; ?>	
</tr>
...
<tr class="" ><td style="<?php echo ($child)? 'font-size:9px;':NULL; ?>" class="left <?php echo $subwidth; ?>" 
...
<!-- chinese below -->
<?php $numcn = count($cngrades); ?>
<table class="clear gis-table-bordered-print table-center table-vcenter <?php echo $subfont.' '.$tblwidth; ?>" >

<tr>
	<th class="<?php echo $subwidth; ?>" >&nbsp;</th>
...
<tr class="" >
<td class="left <?php echo $subwidth; ?>" id="<?php echo $alert; ?>" 
	ondblclick="alert(this.id);" >
	<?php 
		if($child){
			for($s=0;$s<$grade['indent'];$s++){
				echo '&nbsp;';
			}			
		}
	?>	
	...
	<?php $decietc = ($grade['is_aggregate']==1)? '2':$decicard; ?>
	<td><?php $g1 = ($grade['q1'] != 0)? number_format($grade['q1'],$decietc) : ' ' ; echo $g1; ?></td>
	<td><?php $g2 = ($grade['q2'] != 0)? number_format($grade['q2'],$decietc) : ' ' ; echo ($qtr>1 )? $g2:NULL; ?></td>
	<td><?php $g3 = ($grade['q3'] != 0)? number_format($grade['q3'],$decietc) : ' ' ; echo ($qtr>2 )? $g3:NULL; ?></td>
	<td><?php $g4 = ($grade['q4'] != 0)? number_format($grade['q4'],$decietc) : ' ' ; echo ($qtr>3 )? $g4:NULL; ?></td>
	
<?php if($qtr>$qtr_fg): ?>	
	<th><?php echo ($grade['q5'] != 0)? number_format($grade['q5'],$decigenave) : ' ' ; ?></th>	
	<td class="f9" ><?php echo ($grade['q5']<$passing)?'Failed':'Passed'; ?></td>	
<?php endif; ?>
</tr>
...
<tr class="<?php echo $avefont; ?>" >
	<th class="left" >Class Rank</th>
	<th><?php $r1 = $students[$i]['sumo']['rank_classroom_q1']+0; echo $r1; ?></th>
	<th><?php $r2 = $students[$i]['sumo']['rank_classroom_q2']+0; echo ($qtr>1)? $r2:NULL; ?></th>
	<th><?php $r3 = $students[$i]['sumo']['rank_classroom_q3']+0; echo ($qtr>2)? $r3:NULL; ?></th>
	<th><?php $r4 = $students[$i]['sumo']['rank_classroom_q4']+0; echo ($qtr>3)? $r4:NULL; ?></th>
<?php if($qtr>$qtr_fg): ?>		
	<th><?php $rf = $students[$i]['sumo']['rank_classroom_q5']+0; echo ($rf)? $rf:NULL; ?></th>
	<th>&nbsp;</th>	
<?php endif; ?>
</tr>
...
<br />
<table class="gis-table-bordered-print table-center table-vcenter <?php echo $legendfont.' '.$tblwidth; ?>" >
	<tr class="b <?php  ?>"  ><th class="vc200 b center">Descriptors</th><th class="vc200 center" >Grading Scale</th></tr>
	<?php $last_legendcrs = $num_legendcrs-1; ?>
<?php for($l=0;$l<$num_legendcrs;$l++): ?>
	<?php if($l==$last_legendcrs): ?>
		<tr>		
			<td><?php echo $legendcrs[$l]['description']; ?></td>
...
<table class="no-gis-table-bordered table-center table-vcenter <?php echo $headfont.' '.$tblrtwidth; ?>" >	
	<tr><td class="b" >CHARACTER TRAITS</td></tr>
</table>
