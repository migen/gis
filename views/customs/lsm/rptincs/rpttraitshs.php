...
?>
<table style="font-size:0.8em;width:<?php echo $ftw; ?>;" class="no-gis-table-bordered center" >	
	<tr><td class="b" >REPORT ON LEARNER'S CHRISTIAN ATTITUDES AND VALUES</td></tr>
</table>


<table class="tbp-right gis-table-bordered-print table-center table-vcenter" style="width:<?php echo $ftw; ?>;" >
<tr class="" >
	<th style="font-size:0.8em;width:<?php echo $trw; ?>;" >Lourdesian Creed Articles | Value Statements </th>
