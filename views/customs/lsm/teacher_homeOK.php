...
<a href="<?php echo URL.'teachers?accor=cls'; ?>" > <button class="vc300 bg-blue2" > <p class="black b f16" > Pending Academic Report (PAR) </p> </button> </a>   

<?php if($num_pending>0): ?>
<table id="cls" class='gis-table-bordered table-fx table-altrow' >
<tr>
	<td colspan="4">
	<?php 	
...
<a href="<?php echo URL.'teachers?accor=sub'; ?>" > <button class="vc300 bg-blue2" > <p class="black b f16" > Submitted Academic Report (SAR) </p> </button>  </a> 

<?php if($num_submitted): ?>

<table id="sub" class='gis-table-bordered table-fx table-altrow'>
<tr class='black bg-blue2'>
	<th>#</th><th>Classroom</th><th> Averages </th><th class="center">Class Records</th> 
</tr>
...
<a href="<?php echo URL.'teachers?accor=adv'; ?>" >  <button class="vc300 bg-blue2" > <p class="black b f16" > Manage Advisory Class (MAC) </p> </button>  </a> 

<table id="adv" class='gis-table-bordered table-fx table-altrow'>
<tr class='black bg-blue2'>
	<th>#</th>
	<th>Classlist</th>
...
<a href="<?php echo URL.'teachers?accor=ctp'; ?>" >  <button class="vc300 bg-blue2" > <p class="black b f16" > Conduct / Trait  
	<?php echo (isset($trs))? '('.$trs.')':NULL; ?>
</p> </button>  </a> 

<table id="ctp" class='gis-table-bordered table-fx table-altrow'>
<tr class='black bg-blue2'>
