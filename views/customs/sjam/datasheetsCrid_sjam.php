...
<h3>
	SJAM Classroom Datasheets (<?php echo ($crid)? $count:NULL; ?>) | <?php $this->shovel('homelinks'); ?>
	| <a href="<?php echo URL.'datasheets/level'; ?>" >Level</a>
...
<?php else: ?>
<div><span class="b" ><?php echo $cr['classroom'].' - '.$cr['adviser']; ?></span></div><br />
