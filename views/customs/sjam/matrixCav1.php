...
<div class="bordered signature" align="center" >
	<div >
		Checked and Noted by: <br /><br /><br /><hr width="20%" /><?php echo strtoupper($vice_principal); ?>
	</div>
	<div >
		Approved by: <br /><br /><br /><hr width="20%" /><?php echo strtoupper($principal); ?>
	</div>	
