...
// $vfile='customs/sjam';
// pr($vfile);
$vpo=isset($vpo)? $vpo:null;
$hpo=isset($hpo)? $hpo:null;
...
<style>
	...
	.coltr{ border:1px solid white;width:3.2in;float:left;padding-left:0.2in; }
...
<?php for($it=0;$it<$numtr;$it++): ?>
	...
	<?php if((($it%$numrows)==0) && ($it>0)): ?>	
		<?php $ndr++; ?>
		<?php if($ndr<$ndc): ?></table></div>
		<div class='coltr' ><table class="gis-table-bordered" ><?php endif; ?>
	<?php endif; ?>	
	...
	<?php if(isset($conducts[$iu]['critype_id']) && ($conducts[$it]['critype_id']!=@$conducts[$iu]['critype_id'])): ?>
		<tr><th colspan=3 ><?php echo @$conducts[$iu]['critype']; ?></th></tr>
	<?php endif; ?>	
<?php endfor; ?>	
</table>
	</div>
