...
<style>
	.div1,.div2{ width:14.0in;height:8.5in;border:1px solid white;margin:0;padding:0;font-size:1.0em; }
...
<tr><th colspan=3 ><?php echo '#'.$conducts[0]['critype_id'].'-'.$conducts[0]['critype']; ?></th></tr>
<?php for($it=0;$it<$numtr;$it++): ?>
	...
	<tr><td><?php echo $conducts[$it]['critype_id'].'-'.$conducts[$it]['trait']; ?></td>
		<td class="vc30 center" ><?php echo $conducts[$it]['dg1']; ?></td>
