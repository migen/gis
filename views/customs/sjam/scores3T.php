...
$gender_colspan=($num_activities+9);


$is_shs=($course['level_id']>13)? 1:0;
...
function getSac($db,$dbg,$dbo,$dept_id,$subject_id){
	...
	INNER JOIN {$dbg}.05_subjects_coordinators AS sc ON sc.hcid=c.id 
...
<?php endif; ?>
	| <a href='<?php echo URL."teachers/scores/$course_id/$sy/$qtr?multiple"; ?>' >Multiple</a> 		
...
<table id="tblExport"  class='clear table-bordered table-fx table-scores' style="font-size:1em;" >


<?php 

require_once('private/scores_header2TDetailed.php');			
$incs="private/scores_data2T{$algo}.php";
require_once($incs);			
