...
<tr><th class="tdscore" colspan="<?php echo (9+$num_activities); ?>" >BOYS</th></tr>
...
<?php if($qtr==4): ?> <!-- if Q4 -->			
		<?php 
			...
			$sumave+=number_format($ge,$decicard);
			$ave=($sumave/$qtr);
...
<?php if(isset($students[$t]['is_male']) && (($students[$s]['is_male']!=$students[$t]['is_male']))): ?>
	<?php $ct=0; ?>
	<tr><th class="tdscore" colspan="<?php echo (9+$num_activities); ?>" >GIRLS</th></tr>
<?php endif; ?>
