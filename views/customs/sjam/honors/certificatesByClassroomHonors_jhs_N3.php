...
$principal_ec=$_SESSION['settings']['principal_ec'];
	...
	<div class="certificate-details">
		<div class="header">
			...
			<div class="school-info">
				...
				<div class="level">Night High School Level</div>
				<div class="sy">School Year <?php echo $sy.' - '.($sy+1); ?></div>
			</div>
		</div>
		<div class="content">
			<div class="this">This <?php echo $qtr_word; ?> Quarter</div>
			<div class="acadAwards">Academic Award</div>
			<div class="givenTo">IS PROUDLY GIVEN TO</div>
			<div class="student-name"><u><?php echo $student; ?></u></div>
			<div class="rank">"<?php echo $rank; ?> HONORS"</div>
			
			<!-- <div class="lvlSection"><?php echo $cr['level'].' - '.$cr['section']; ?></div> -->
			<div class="lvlSection"><?php echo 'Fifth Year - '.$cr['section']; ?></div>
			
		</div>
		<div class="footer">
			<div class="data-item-night">
				<div class="school-head">
					<u><?php echo $principal_ec; ?></u><br>
					<small>Night High School Principal</small>
				</div>
			</div>
			<!-- <div class="data-item">
				<div class="school-head">
					<u>Mrs. Imelda B. Sia</u><br>
					<small>HS Assistant Principal For Academic Affairs</small>
				</div>
