...
?>
<h5 class="screen" >
	SJAM CAV Matrix (<?php echo $count; ?>)	
...
<?php foreach($critypes AS $row): ?>	
	...
	<th class="center" colspan="<?php echo $row['num']; ?>" ><?php echo $row['critype']; ?>
		<a href='<?php echo URL."cav/matrixByCritype/$crid/$critype_id/$sy/$qtr&value={$traits_value_dg}"; ?>' ><?php echo "({$numtrs})"; ?></a>
	</th>	
...
<div class="signature" align="center" >
	<table class="table-signatories nogis-table-bordered" >
		<tr><td>Checked and Noted by: </td><td style="width:150px;" >&nbsp;</td><td>Approved by:</td></tr>
		<tr><td></td><td>&nbsp;</td><td></td></tr>
		<tr><td></td><td>&nbsp;</td><td></td></tr>
		<tr><td>__________________________________</td><td>&nbsp;</td><td>__________________________________</td></tr>
		<tr><td><?php echo strtoupper($vice_principal); ?></td><td>&nbsp;</td><td><?php echo strtoupper($principal); ?></td></tr>
	</table>
