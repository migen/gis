...
<h5>
	SJAM Custom Classlist 
	| With Honors & Conduct Awardees
...
$q="SELECT
		c.id,c.name,c.code,c.lrn,c.position,summ.scid,c.is_male,c.is_active,sumx.*,aw.*		
	FROM {$dbg}.05_summaries AS summ
	LEFT JOIN {$dbg}.05_summext AS sumx ON sumx.scid=summ.scid
	LEFT JOIN {$dbg}.05_awardees AS aw ON aw.scid=summ.scid
...
<tr>
	...
	<th class="center" >CDT<br>Q1</th>
	<th class="center" >CDT<br>Q2</th>
	<th class="center" >CDT<br>Q3</th>
	<th class="center" >CDT<br>Q4</th>
...
<tr>
	...
	<?php for($q=1;$q<5;$q++): ?>
		<td class="center" >
			<?php if($boys[$i]['is_conduct_awardee_q'.$q]>0): ?>
				<a href="<?php echo URL.'certificates/studentConductee/'.$boys[$i]['scid'].DS.$sy.'/'.$q; ?>" >Y</a>
			<?php endif; ?>
		</td>
	<?php endfor; ?>
...
<tr>
	...
	<?php for($q=1;$q<5;$q++): ?>
		<td class="center" >
			<?php if($girls[$i]['is_conduct_awardee_q'.$q]>0): ?>
				<a href="<?php echo URL.'certificates/studentConductee/'.$girls[$i]['scid'].DS.$sy.'/'.$q; ?>" >Y</a>
			<?php endif; ?>
		</td>
	<?php endfor; ?>
