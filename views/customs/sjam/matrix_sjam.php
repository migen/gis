...
$decicard=($qtr>4)? $deciave:$decicard;
...
<h5 class="screen" >
	<span ondblclick="tracehd();"  >SJAM Matrix (<?php echo $count; ?>)
	| <span class="u" ondblclick="tracehd();" >CRID#<?php echo $crid; ?></span>
	| <a href="<?php echo URL.$home; ?>">Home</a>
	
<?php if($qtr<>5): ?>	
	| <a href='<?php echo URL."matrix/grades/$crid/$sy/5"; ?>' >Final</a> 		
<?php else: ?>
...
<?php endif; ?>
	...
	<?php if($_SESSION['srid']!=RMIS OR $_SESSION['srid']==RREG): ?>
...
<table id="tblExport" class='gis-table-bordered table-fx table-altrow' style="width:1200px;float:left;font-size:<?php echo $size; ?>em;" >
<tr class='bg-blue2'>
	<th>#</th>	
	...
	</th>	<!-- left to right,iterate thru subjects -->
	<?php $s=0; ?>
...
<?php  echo ($grades[$is][$ic]['is_num']==1)? 
	($grades[$is][$ic]['q'.$qtr]<0)? '':number_format($grades[$is][$ic]['q'.$qtr],$decicard):
	$grades[$is][$ic]['dg'.$qtr]; ?>
		<br /></td>	
	...
	<td class="vcenter center" ><?php echo $attd[$is]['total_present']+0; ?></td>
	<td class="vcenter center" ><?php echo $attd[$is]['total_tardy']+0; ?></td>		
