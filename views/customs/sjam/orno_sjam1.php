...
<body>
	<style type="text/css" media="screen">
        ...
        @media print{ 
            .screen{ display:none; text-decoration: underline; }
        }
	...
	<div class="or-wrapper">
			...
			<table>
				<tr>
					...
					<td>
						<center>
							<p class="sch-detail">
								<span class="screen" style="font-size: 25px;">ST. JAMES ACADEMY</span><br>
				...
				<tr>
					<td><b>OFFICIAL RECIEPT<br><small>(EXEMPT)</small></b></td>
		...
		<div class="pay-detail">
			<table>			
				<tr>
					<td><b>AMOUNT RECIEVED:</b> &nbsp;<span><u><?php echo number_format($total_received,2); ?></u></span></td>
