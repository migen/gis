...
<table class="vc700 tf16 nogis-table-bordered" >
<tr><td colspan=2 class="left" >Name :<span class="u" ><?php echo $student['student']; ?></span></td></tr>
...
<tr><td colspan=2 class="left" >
	Grade & Section: <span class="u" ><?php echo $student['level'].'-'.$classroom['label']; ?></span>
</td></tr>
