	...
	<table class="nogis-table-bordered-print center <?php echo $headfont.' '.$tblwidth; ?>" >
		...
		<tr>
			...
			<td>
				...
				<?php endif; ?>			
				<span class="" >Night High School</span><br />
				<span class="" >Five - Year Program<br />	
				<span class="f18 " ><?php echo strtoupper($ordinalQtr); echo ($qtr<4)? " QUARTER":NULL; ?> REPORT CARD</span>				
			</td>
