...
<table class="studhome accordion gis-table-bordered table-altrow" >
	...
	<?php if($has_honors): ?>
		<tr><td>
			<a href='<?php echo URL."certificates/studentHonors/$scid/$sy_enrollment/$qtr"; ?>' >
	...
	<?php if($is_conductee): ?>
		<tr><td>
			<a href='<?php echo URL."certificates/studentConductee/$scid/$sy_enrollment/$qtr"; ?>' >
...
<?php if($scid): ?>
	...
	<?php elseif($currlvl<14): ?>
		...
		<?php else: ?>
			<tr class="red" ><th><?php echo $enrollment['denied_message']; ?></th></tr>
		<?php endif; ?>	
	<?php else: ?>
		<?php 
			$half=($qtr<3)? 1:2;		
	...
	<?php endif; ?>	
	<?php if($srid==RSTUD): ?>
		<tr><td><a href='<?php echo URL."students/unsetter/enrollment"; ?>' >Refresh Account Session</a></td></tr>			
	<?php endif; ?>
<?php else: ?>
