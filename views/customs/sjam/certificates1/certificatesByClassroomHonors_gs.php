	...
	<div class="certificate-details">
		<div class="header">
			...
			<div class="school-info">
				...
				<div class="level"><?php echo $department; ?> Level</div>
		...
		<div class="content">
			...
			<div class="lvlSection"><?php echo $classroom; ?></div>
		</div>
		<div class="footer">
			<div class="data-item">
				<div class="school-head">
					<u><?php echo $principal_dept; ?></u><br>
					<small>GS Assistant Principal For Academic Affairs</small>
				</div>
			...
			<div class="data-item">
				<div class="school-head">
					...
					<small>Basic Education Asst. Principal</small>
				</div>
