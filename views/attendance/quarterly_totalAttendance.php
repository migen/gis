<?php 
	$qvsum=($qtr<5)? "q{$qtr}_days_present":"year_days_total";
?>
...
<?php endif; ?>
	...
	| <a href='<?php echo URL."attendance/quarterly/$crid/$sy/4"; ?>' />Q4</a>  	
...
<?php 
$qvpre=$rows[$i]['q1_days_present']+$rows[$i]['q2_days_present']+$rows[$i]['q3_days_present']+$rows[$i]['q4_days_present'];
$qvtar=$rows[$i]['q1_days_tardy']+$rows[$i]['q2_days_tardy']+$rows[$i]['q3_days_tardy']+$rows[$i]['q4_days_tardy'];
?>
<tr>
	<td><?php echo $i+1; ?></td>
	...
	<td><input name="posts[<?php echo $i; ?>][present]" tabindex="2"
		class="vc50 center present" id="present<?php echo $i; ?>" value="<?php echo $qvpre; ?>" /></td>
	<td><input name="posts[<?php echo $i; ?>][tardy]" value="<?php echo $qvtar; ?>" tabindex="4"
