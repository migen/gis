<h5>
	Courses <span class="u" onclick="tracehd();" >SETUP</span> <?php echo $level['name']; ?>	
	| <a href="<?php echo URL.$_SESSION['home']; ?>" />Home</a>  
	<?php echo isset($_SERVER['HTTP_REFERER'])? '| <a href="'.$_SERVER['HTTP_REFERER'].'" >Back</a>' : ''; ?>
	| <a href="<?php echo URL.'courses/settings/'.$lvl; ?>" />Courses Settings</a>  
...
<tr>
	...
	<td><span class="hd" ><a href="<?php echo URL.'purge/levelCourses?lvl='.$lvl.'&sub='.$subjects[$i]['subject_id']; ?>" 
		class="" onclick="return confirm('Dangerous! Sure?');" >PurgeLC</a></span></td>
