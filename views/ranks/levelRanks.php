...
<h5>
	<?php echo $level['code']; ?>  - GIS Rank Level Genave - <?php echo $count; ?>
<?php if(!isset($_GET['details'])): ?>
	
	| <a href="<?php echo $url.'&details'; ?>" class="u" >Details</a>	
	| <a href="<?php echo URL.'ranks/levelWithHonors/'.$lvl; ?>" class="u" >WithHonors</a>	
<?php endif; ?>	
	...
	| <a href="<?php echo URL.'ranks/level/'.$lvl.DS.$sy.DS.$qtr.'?num=1'; ?>" >Regular</a>
	| <a href="<?php echo URL.'ranks/level/'.$lvl.DS.$sy.DS.$qtr.'?num=2'; ?>" >EC</a>
	| <a href="<?php echo URL.'ranks/level/'.$lvl.DS.$sy.DS.$qtr.'?num=all'; ?>" >All</a>

	<?php if(($lvl>13) && ($qtr>3)): ?>
		| <a href="<?php echo URL.'ranktools/viewAveTwoSems/'.$lvl.DS.$sy.DS.'7'; ?>" >SemsAve</a>
		<a href="<?php echo URL.'ranktools/updateAveTwoSems/'.$lvl.DS.$sy.DS.'7'; ?>" >(Process)</a>
	<?php endif; ?>
	<?php if(($lvl<14) && ($qtr>3)): ?>
		| <a href="<?php echo URL.'ranks/level/'.$lvl.DS.$sy.DS.'5'; ?>" >Final</a>
		| <a href="<?php echo URL.'registrars/qlra/'.$lvl.DS.$sy.DS.'5'; ?>" >Sort</a>
	<?php endif; ?>
