...
<tr><th class="vc150" >SMS Network</th>
	<td>
		<select class="full pdl05" name="data[sms_network_id]" >
			<?php	foreach($data["selects"]["sms_networks"] as $sel): ?>
			<option <?php echo ($sel["id"] == $row["sms_network_id"])? "selected" : null; ?> value="<?php echo $sel['id']; ?>" ><?php echo $sel["name"]; ?></option><?php	endforeach; ?>
		</select>		
	</td>
</tr>
