...
$assarr=$getAssessment($tfee_total,$paymode);
...
<table class="gis-table-bordered" >
	...
	<tr><th>Student</th><td><?php echo $student['studname']; ?></td>
		<th>Amount</th><td class="right" ><?php echo number_format($student['amount'],2); ?></td></tr>
