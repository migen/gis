...
function putPayment(dbtable,num){
	...
	pdata+="&sy="+sy+"&scid="+scid+"&feetype_id="+feetype_id+"&amount="+amount+"&date="+date+"&ecid="+ecid;
	pdata+="&reference="+reference+"&orno="+orno+"&ptr="+ptr+"&received="+received+"&change="+change;
	$('#btnAdd-'+num).hide();
