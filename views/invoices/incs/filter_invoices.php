...
<table class="gis-table-bordered table-fx table-altrow" >
	...
	<tr>
		<th>Payor Type</th>
		<td>
			<select class="full" name="payortype_id" >
				<option value="" >Any</option>
				<?php foreach($payortypes AS $sel): ?>
					<option value="<?php echo $sel['id']; ?>" 
						<?php echo (isset($_POST['payortype_id']))? $_POST['payortype_id']:NULL;?> >
	...
	<tr><th>Guest (Other)</th><td>
		<input class="pdl05 full" name="scid" id="scid" placeholder="Cust"  />				
	</td></tr>	
