...
if($qtr>4){
	$decigenave=$_SESSION['settings']['decifgenave'];	
}

$decigenave=isset($_GET['deci'])? $_GET['deci']:$decigenave;
...
<h5>
	...
	Classroom Ranks - SIR (<?php echo $count; ?>)
...
<p class="brown screen" >Click 1) Edit and 2) Submit - to update.</p>
