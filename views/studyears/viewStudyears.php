...
<tr><th>Beginning SY</th><td><?php echo $row['begsy']; ?></td></tr>
<tr><th>Ending SY</th><td><?php echo $row['endsy']; ?></td></tr>
...
<tr><td><a href='<?php echo URL."grades/student/$scid?all"; ?>' >Grades</a></td></tr>
...
function redirContact(ucid){
	var url = gurl+'/studyears/view/'+ucid;	
	window.location = url;		
}
