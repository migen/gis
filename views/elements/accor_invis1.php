...
<button onclick="accorToggle('invis')" style="width:262px;" class="bg-blue2" > <p class="b f16" >Inventory</p> </button>  	
<table id="invis" class="gis-table-bordered table-fx" >



<tr><th class="center" >-Sales | POS-</th></tr>
<tr><td class="" > 
...
<tr><th class="center" >-Stocks-</th></tr>
<tr><td> 
