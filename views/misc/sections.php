...
<h5>
	...
	| <a href="<?php echo URL.$home.'/classrooms/1'; ?>" /> Classrooms </a>  
	| <a href="<?php echo URL.'mis/sections?sort=id'; ?>" />Sort ID</a>  
...
<?php for($i=0;$i<$num_sections;$i++): ?>
	<tr rel="<?php echo $i; ?>" >
		...
		<td>
			...
			<u id="<?php echo $i; ?>" class="blue" onclick='xedit(this.id);return false;' >Xedit</u> 			
		</td>
	</tr>	
<?php endfor; ?>
...
<tr >
	...
	<td><input id="sxncode<?php echo $i; ?>" class="full" type="text" name="sections[<?php echo $i; ?>][code]" maxlength="4" /></td>		
