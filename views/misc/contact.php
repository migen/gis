...
<th class="vc100" >
	...
	<th class="vc200" >Full Name<br /><span class='tf12' >Surname, First Middle</span></th>
...
<tr class="rc" >
	...
	<td>
		<select class="title" onchange="xgetPriv(this.value,this.id)" id="<?php echo $i; ?>" name="contacts[<?php echo $i; ?>][tid]" >
			...
			<?php foreach($titles AS $sel): ?> 
				<option value="<?php echo $sel['id']; ?>"  ><?php echo $sel['name'].' R'.$sel['rid'].'-P'.$sel['priv']; ?></option>
			<?php endforeach; ?>
		</select>	
	</td>	
	...
	<td class="hd"><input id="remarks<?php echo $i; ?>" class="pdl05 vc120" name="contacts[<?php echo $i; ?>][remarks]" /></td>
	
	<td class="" ><input id="tid<?php echo $i; ?>" class="pdl05 vc25" type="text" name="contacts[<?php echo $i; ?>][title]" readonly /></td>
	<td class="" ><input id="role<?php echo $i; ?>" class="pdl05 vc25" type="text" name="contacts[<?php echo $i; ?>][role]" readonly /></td>
	<td class="" ><input id="priv<?php echo $i; ?>" class="pdl05 vc25" type="text" name="contacts[<?php echo $i; ?>][priv]" readonly /></td>

	<td><input class="center vc50" name="contacts[<?php echo $i; ?>][sy]" value="<?php echo (DBYR+1); ?>" /></td>
