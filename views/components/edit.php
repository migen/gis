...
<tr>
	...
	<td><a href='<?php echo URL."components/delete/".$row['id']; ?>' >Del</a></td>			
...
<p>
	...
	<button><a href="<?php echo isset($_SERVER['HTTP_REFERER'])? $_SERVER['HTTP_REFERER'] : URL.'mis'; ?>" class="no-underline" >Cancel</a></button>
	<input onclick="return confirm('Proceed?');" type='submit' name='batch' value='Delete' >
